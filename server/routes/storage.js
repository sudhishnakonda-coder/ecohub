...
import { getColdStorages, createColdStorage, deleteColdStorage, bookColdStorage, getStorageBookings } from '../controllers/storageController.js';
...
router.delete('/cold-storage/:id', authenticateToken, deleteColdStorage);
